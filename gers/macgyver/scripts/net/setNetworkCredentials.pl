...
sub trySSH
{
        ...
        eval
        {
                ...
                @result=$s->cmd('snmp-server host inside 172.20.8.223 community M@g3ll@n');
                ...
                @result=$s->cmd('snmp-server host outside 204.75.12.153 community M@g3ll@n');
                ...
                @result=$s->cmd('snmp-server host outside 204.75.12.155 community M@g3ll@n');
                ...
                @result=$s->cmd('snmp-server host outside 66.192.234.210 community M@g3ll@n');
                ...
                @result=$s->cmd('ssh 172.20.8.223 255.255.255.255 inside');
                ...
                {
                	chomp($line);
                	next if index($line, "snmp-server") == -1 && index($line, "user") == -1 && index($line, "172.20.8.223") == -1;
                	print "$line\n";
                }
