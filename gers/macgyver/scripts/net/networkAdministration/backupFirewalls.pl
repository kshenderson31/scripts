...
#216.9.106.159,SFO-9415-Warehouse,admin,install,install1		*** Removed after conversation with SFO IT, circuit is not a Paradies drop
...
#70.155.115.242,ATL-9770-Manager.Office,admin,install,install1			*** Removed based on Atlanta visit; Paul Fite and Chris Hamblin
